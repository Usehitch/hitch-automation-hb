...
```
Error: View button did not appear for "test.ftk78.1783283569074@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet.
...
Call log:
  - View button did not appear for "test.ftk78.1783283569074@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet. with timeout 10000ms
        ...
        - generic [ref=e165]:
          - generic [ref=e166]:
            - generic [ref=e167]:
              - generic [ref=e168]:
                - img [ref=e169]
                - textbox "Search by email, name, full address or loan number" [active] [ref=e172]: test.ftk78.1783283569074@mailinator.com
