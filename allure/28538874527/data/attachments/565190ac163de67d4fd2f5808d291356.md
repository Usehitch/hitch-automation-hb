...
```
Error: View button did not appear for "test.541vi.1782930629628@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet.
...
Call log:
  - View button did not appear for "test.541vi.1782930629628@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet. with timeout 10000ms
        ...
        - generic [ref=e167]:
          - generic [ref=e168]:
            - generic [ref=e169]:
              - generic [ref=e170]:
                - img [ref=e171]
                - textbox "Search by email, name, full address or loan number" [active] [ref=e174]: test.541vi.1782930629628@mailinator.com
