...
```
Error: View button did not appear for "test.a2o53.1783110063311@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet.
...
Call log:
  - View button did not appear for "test.a2o53.1783110063311@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet. with timeout 10000ms
...
- generic [ref=e1]:
        ...
        - generic [ref=e126]:
          - generic [ref=e127]:
            - generic [ref=e128]:
              - generic [ref=e129]:
                - img [ref=e130]
                - textbox "Search by email, name, full address or loan number" [active] [ref=e133]: test.a2o53.1783110063311@mailinator.com
                      ...
                      - cell "Andy America 5121231113" [ref=e201]:
                        - generic [ref=e202]:
                          - link "Andy America" [ref=e203] [cursor=pointer]:
                            - /url: /portal/loan/6a4819bc8053f6810548b424/summary/overview
  ...
  - generic:
    - generic:
      - generic [ref=e246]:
        - iframe [ref=e247]:
          - button "Close message from company" [ref=f22e4] [cursor=pointer]:
            - img [ref=f22e5]
        - iframe [ref=e248]:
          - button "Hi. Need any help?" [ref=f23e5] [cursor=pointer]
      - iframe [ref=e249]:
        - button "Open messaging window" [ref=f24e5] [cursor=pointer]:
          - img [ref=f24e7]
          - img [ref=f24e10]
```
