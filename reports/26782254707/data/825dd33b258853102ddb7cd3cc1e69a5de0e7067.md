...
Locator: locator('[role="dialog"]').filter({ has: getByText('Filter Applications By:', { exact: true }) }).locator('div').filter({ has: locator('label').filter({ hasText: /^Status$/i }) }).last()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[role="dialog"]').filter({ has: getByText('Filter Applications By:', { exact: true }) }).locator('div').filter({ has: locator('label').filter({ hasText: /^Status$/i }) }).last()
                      ...
                      - cell "Andy America 512-123-1113" [ref=e237]:
                        - generic [ref=e238]:
                          - link "Andy America" [ref=e239] [cursor=pointer]:
                            - /url: /portal/loan/6a1df7c7abe097c5cafd7af1/summary/overview
