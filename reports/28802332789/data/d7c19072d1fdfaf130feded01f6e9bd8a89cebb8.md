...
```
Error: View button did not appear for "test.uwv6o.1783351251983@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet.
...
Call log:
  - View button did not appear for "test.uwv6o.1783351251983@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet. with timeout 10000ms
        ...
        - generic [ref=e165]:
          - generic [ref=e166]:
            - generic [ref=e167]:
              - generic [ref=e168]:
                - img [ref=e169]
                - textbox "Search by email, name, full address or loan number" [active] [ref=e172]: test.uwv6o.1783351251983@mailinator.com
                      ...
                      - cell "Andy America, Amy America 5121231113" [ref=e240]:
                        - generic [ref=e241]:
                          - link "Andy America, Amy America" [ref=e242] [cursor=pointer]:
                            - /url: /portal/loan/6a4bc7e1cf6fe330c52bfa3e/summary/overview
