...
- Name: loandetail.spec.js >> Loan Detail — Tracker tab >> Current stage step rows are visible
- Location: tests/loandetail.spec.js:149:9
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e7]:
      - generic [ref=e8]: "Request ID: a06000121ca1cb93-LAX"
