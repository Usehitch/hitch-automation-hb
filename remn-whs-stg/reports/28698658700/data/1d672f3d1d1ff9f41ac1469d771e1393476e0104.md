...
```
Error: View button did not appear for "test.h756x.1783149041572@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet.
...
Call log:
  - View button did not appear for "test.h756x.1783149041572@mailinator.com" after 4 search attempts — the newly created loan may not be indexed in My Loans search yet. with timeout 10000ms
        ...
        - generic [ref=e149]:
          - generic [ref=e150]:
            - generic [ref=e151]:
              - generic [ref=e152]:
                - img [ref=e153]
                - textbox "Search by email, name, full address or loan number" [active] [ref=e156]: test.h756x.1783149041572@mailinator.com
